...
def configure_mmtk():
    incpath = "/home/captain/projects/LBO/mmtk-pypy/target"
    rootlibpath = "/home/captain/projects/LBO/mmtk-pypy/target"

    eci = ExternalCompilationInfo(
        include_dirs=[incpath],
        includes=["mmtk.h"],
        library_dirs=[incpath, rootlibpath],
        libraries=["/home/captain/projects/LBO/mmtk-pypy/target/debug/libmmtk_pypy.so"],
        use_cpp_linker=True,
    )
